...
local function UpdateText()
    ...
    if #selectedNames > 0 then
        Button.Text = table.concat(selectedNames, ", ")
    else
        Button.Text = "Select..."
    end
end
...
local function AddOption(Name, Value)
    ...
    OptionButton.MouseButton1Click:Connect(function()
        ...
        SelectedValues[Value] = Selected[Name]
...
local function RemoveOption(index, Value)
    if Options[index] then
        Selected[Options[index].Name] = nil
...
local function ToggleOption(OptionName)
    if Selected[OptionName] ~= nil then
        Selected[OptionName] = not Selected[OptionName]
        SelectedValues[OptionName] = Selected[OptionName]
        
        for _, optionBtn in pairs(OptionsFrame:GetChildren()) do
            if optionBtn:IsA("TextButton") and optionBtn.Name == OptionName then
...
function Dropdown:Clear()
    ...
    for val, _ in pairs(SelectedValues) do
        SelectedValues[val] = false
    end
