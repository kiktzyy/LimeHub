...
function Tab:AddInput(Configs)
    ...
    if IInputIcon then
        ...
        TextBoxInput.Size = UDim2.new(0.75, 0, 0.85, 0)
        TextBoxInput.Position = UDim2.new(0.4, 0, 0.5, 0)
        TextBoxInput.AnchorPoint = Vector2.new(0.5, 0.5)
    end

    local Pencil = Create("ImageLabel", InputFrame, {
        Size = UDim2.new(0, 12, 0, 12),
        Position = UDim2.new(1, 5, 0.5),
        AnchorPoint = Vector2.new(0, 0.5),
        Image = "rbxassetid://15637081879", -- Icon pencil
        BackgroundTransparency = 1,
        ImageColor3 = Theme["Color Dark Text"]
    })
    ...
    local function HandleInput()
        ...
        if Text:gsub(" ", ""):len() > 0 or Text == "" then
